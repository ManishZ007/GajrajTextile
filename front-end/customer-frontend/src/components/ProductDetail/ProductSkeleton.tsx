      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="lg:w-[45%] flex gap-3">
          <div className="hidden sm:flex flex-col gap-2.5">
            {[...Array(4)].map((_, i) => (
              <Bone key={i} style={{ width: '56px', height: '72px', borderRadius: '12px' }} />
            ))}
          </div>
          <Bone
            style={{ flex: 1, minHeight: '480px', maxHeight: '660px', borderRadius: '18px' }}
          />
        </div>
        ...
        <div className="lg:w-[55%] space-y-5 pt-1">
          ...
          <Bone style={{ width: '130px', height: '26px', borderRadius: '6px' }} />
          <Bone style={{ width: '76px', height: '22px', borderRadius: '999px' }} />
          ...
          <div style={{ paddingTop: '6px', borderTop: '1px solid rgba(0,0,0,0.05)' }}>
            <Bone style={{ width: '80px', height: '10px', marginBottom: '14px' }} />
            <div className="flex gap-2.5">
              {[...Array(5)].map((_, i) => (
                <Bone key={i} style={{ width: '30px', height: '30px', borderRadius: '50%' }} />
              ))}
            </div>
          </div>

          <div style={{ paddingTop: '6px', borderTop: '1px solid rgba(0,0,0,0.05)' }}>
            <Bone style={{ width: '60px', height: '10px', marginBottom: '14px' }} />
          ...
          <div
            ...
            style={{ paddingTop: '8px', borderTop: '1px solid rgba(0,0,0,0.05)' }}
          >
            <Bone style={{ flex: 1, height: '52px', borderRadius: '16px' }} />
            <Bone style={{ width: '155px', height: '52px', borderRadius: '16px' }} />
          </div>
        </div>
      </div>
    </div>
