...
export default function Login() {
  ...
  const cardStyle: React.CSSProperties = {
    ...
    boxShadow:
      '0 8px 40px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.08)',
  };
  ...
  const inputStyle: React.CSSProperties = {
    ...
    border: '1px solid var(--color-glass-border)',
    boxShadow:
      '0 4px 24px rgba(0,0,0,0.10), inset 0 1px 0 rgba(255,255,255,0.08)',
  };
        ...
        <form onSubmit={handleCredentials} className="flex flex-col gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full h-12 rounded-full pl-11 pr-5 text-sm outline-none placeholder:text-(--color-text-subtle)"
              style={inputStyle}
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full h-12 rounded-full pl-11 pr-11 text-sm outline-none placeholder:text-(--color-text-subtle)"
              style={inputStyle}
            />
            <button
              type="button"
