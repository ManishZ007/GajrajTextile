          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <p
                ...
                style={{ color: 'var(--color-text)', fontFamily: 'Clamp', fontWeight: 500, letterSpacing: '0.04em' }}
              >
                {order.orderNumber}
              </p>
        ...
        {shipping?.trackingNumber && (
          ...
          >
            ...
            <p className="text-[11px]" style={{ color: 'var(--color-text-subtle)' }}>
              Tracking:{' '}
              <span style={{ fontFamily: 'Clamp', fontWeight: 500, color: 'var(--color-text)' }}>
                {shipping.trackingNumber}
              </span>
          ...
          <div>
            ...
            {!loading && totalElements > 0 && (
              <p className="text-[12px] mt-0.5" style={{ color: 'var(--color-text-subtle)' }}>
                <span style={{ fontFamily: 'Clamp', fontWeight: 500 }}>{totalElements}</span> order{totalElements !== 1 ? 's' : ''} placed
              </p>
            )}
          </div>
