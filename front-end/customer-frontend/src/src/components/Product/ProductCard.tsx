    ...
    >
      ...
      <div
        ...
        style={{
          ...
          border: '1px solid rgba(101, 101, 101, 0.04)',
          borderRadius: '18px',
          zIndex: 10,
          padding: '16px 12px',
        }}
      >
        ...
        <p
          className=" leading-[1.15] text-[11px] md:text-[14px]"
          style={{
            marginTop: '10%',
        ...
        {product.description && (
          <p
            ...
            className="text-[10px]/3 md:text-[13px]/[17px] line-clamp-5 md:line-clamp-6 mt-[9px] md:mt-[12px] "
          >
            {product.description}
          </p>
        )}
        ...
        <div
          style={{
            marginTop: '12px',
            height: '1px',
            background: 'rgba(79, 79, 79, 0.265)',
          }}
        />
      ...
      {isCustomizable && (
        <button
          ...
          className="absolute flex items-center md:w-[calc(50%-5%)] py-2 px-2 md:px-3 justify-between cursor-pointer transition-transform duration-150 hover:scale-[0.96] active:scale-[0.93] "
          style={{
            bottom: '3%',
            left: '3.5%',
            // width: 'calc(50% - 5%)',
            background: 'rgba(112, 112, 112, 0.146)',
            borderRadius: '999px',
