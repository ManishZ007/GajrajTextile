...
const LandingNavbar = memo(
  ({
    ...
    const showWhite = !isHome || scrolled || hovered;
    ...
    return (
      <>
        <header
          ...
          className={`fixed pt-3.5 pb-1 md:pt-4 md:pb-0 px-3 top-0 left-0 w-full h-15 md:h-18 z-50 transition-all duration-500 ease-in-out overflow-visible
        ${
          showWhite
            ? 'bg-white/90 backdrop-blur-xl border-b border-black/[0.07]'
          ...
          <div className="relative md:px-10 flex items-center justify-between">
            ...
            <div className="flex items-center justify-center">
              ...
              >
                <Menu
                  ...
                  style={{
                    color: showWhite ? '#0a0a0a' : 'rgba(255,255,255,0.92)',
                  }}
                />
              </button>
            </div>
            ...
            <div className="flex items-center gap-4">
              <SearchButton
                ...
                blackColor={showWhite}
              />
              <CartButton blackColor={showWhite} />
